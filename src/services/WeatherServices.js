...
const API_KEY = 'd0f972496034eeeeefe8220e6c6ae765'
...
const formatCurrentWeather = (data) => {
    ...
    return { lat, lon, temp, feels_like, temp_min, temp_max, name, humidity, dt, country, sunrise, sunset, details, icon, speed }
}
